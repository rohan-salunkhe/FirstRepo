...
public class AddRecord extends JFrame {
	...
	public AddRecord()
	{
		...
		r4.setActionCommand("BTECH");
		
		String Trades[] ={"Civil","Mechanical","Electronics","Computer","IT","AIDS"};
		l1= new JList(Trades);
